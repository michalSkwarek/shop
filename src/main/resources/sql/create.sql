...
-- ----------------------------------------------
-- add few accounts
INSERT INTO account (id, username, password, email, created_at, updated_at, enabled, role) VALUES (1, 'aaa', '111', 'a1@gmail.com', STR_TO_DATE('21-03-2007 05:31:55', '%d-%m-%Y %H:%i:%s'), null, 1, 'ADMIN');
INSERT INTO account (id, username, password, email, created_at, updated_at, enabled, role) VALUES (101, 'bbb', '222', 'b2@gmail.com', STR_TO_DATE('14-11-2008 20:22:31', '%d-%m-%Y %H:%i:%s'), null, 1, 'MODERATOR');
INSERT INTO account (id, username, password, email, created_at, updated_at, enabled, role) VALUES (1001, 'ccc', '333', 'c3@gmail.com', STR_TO_DATE('05-06-2009 11:44:07', '%d-%m-%Y %H:%i:%s'), STR_TO_DATE('06-06-2009 12:44:07', '%d-%m-%Y %H:%i:%s'), 1, 'USER');
INSERT INTO account (id, username, password, email, created_at, updated_at, enabled, role) VALUES (1002, 'ddd', '444', 'd4@gmail.com', STR_TO_DATE('05-06-2009 11:44:07', '%d-%m-%Y %H:%i:%s'), null, 1, 'USER');

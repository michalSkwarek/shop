...
-- ----------------------------------------------
-- add few accounts
INSERT INTO account (id, email, password, created_at, updated_at, enabled, role) VALUES (1, 'a1@gmail.com', '111', STR_TO_DATE('21-03-2007 05:31:55', '%d-%m-%Y %H:%i:%s'), null, 1, 'ADMIN');
INSERT INTO account (id, email, password, created_at, updated_at, enabled, role) VALUES (101, 'b2@gmail.com', '222', STR_TO_DATE('14-11-2008 20:22:31', '%d-%m-%Y %H:%i:%s'), null, 1, 'MODERATOR');
INSERT INTO account (id, email, password, created_at, updated_at, enabled, role) VALUES (1001, 'c3@gmail.com', '333', STR_TO_DATE('05-06-2009 11:44:07', '%d-%m-%Y %H:%i:%s'), STR_TO_DATE('06-06-2009 12:44:07', '%d-%m-%Y %H:%i:%s'), 1, 'USER');
INSERT INTO account (id, email, password, created_at, updated_at, enabled, role) VALUES (1002, 'd4@gmail.com', '444', STR_TO_DATE('05-06-2009 11:44:07', '%d-%m-%Y %H:%i:%s'), null, 1, 'USER');
